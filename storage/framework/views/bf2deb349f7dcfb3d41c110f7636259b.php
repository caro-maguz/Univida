    ...
    <div class="uv-cards-window" id="window">
      ...
      <div class="uv-card" data-idx="0">
        <div class="uv-img-area">
          <img src="<?php echo e(asset('img/imgRutaViolencia.jpeg')); ?>" alt="Ruta violencia de género">
        </div>
        <div class="uv-card-body">
          ...
          <a href="<?php echo e(route('dashboard.user')); ?>" class="uv-btn uv-btn-active">Ingresar &rarr;</a>
        </div>
      </div>
      ...
      <div class="uv-card" data-idx="1">
        <div class="uv-img-area">
          <img src="<?php echo e(asset('img/imgFuturasRutas.jpeg')); ?>" alt="Gestión de solicitudes">
        </div>
        <div class="uv-card-body">
      ...
      <div class="uv-card" data-idx="2">
        <div class="uv-img-area">
          <img src="<?php echo e(asset('img/imgFuturasRutas.jpeg')); ?>" alt="Reportes y estadísticas">
        </div>
        <div class="uv-card-body">
          <span class="uv-badge uv-badge-off">Fuera de servicio</span>
...
</html><?php /**PATH C:\xampp\htdocs\univida\resources\views/seleccion-ruta.blade.php ENDPATH**/ ?>