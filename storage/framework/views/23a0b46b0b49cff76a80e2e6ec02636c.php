...
<body>
  <div class="container">
    ...
    <p class="subtitle">Se ha generado un código de verificación para: <strong><?php echo e($correo); ?></strong></p>
    ...
    <div class="token-box" id="codigoText" style="font-size: 2rem; letter-spacing: 0.5rem;"><?php echo e($codigo); ?></div>
    
    <button class="copy-button" onclick="copyCodigo()">📋 Copiar Código</button>

    <a href="<?php echo e(route('password.reset')); ?>" class="continue-button">
...
<?php /**PATH C:\xampp\htdocs\univida\resources\views/auth/codigo-generated.blade.php ENDPATH**/ ?>