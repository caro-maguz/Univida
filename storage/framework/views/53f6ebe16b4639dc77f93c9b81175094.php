    ...
    <article class="container">
      ...
      <section class="form-section" aria-labelledby="titulo-formulario">
        ...
        <?php if(session('success')): ?>
          <div style="background:#e8f5e9;padding:12px;border-radius:10px;margin-bottom:12px;color:#2e7d32;border:1px solid #c8e6c9;"><?php echo e(session('success')); ?></div>
        <?php endif; ?>
        <?php if($errors->any()): ?>
        ...
        <?php endif; ?>
        <form action="<?php echo e(route('reporte.store')); ?>" method="post">
          <?php echo csrf_field(); ?>
          <label for="violencia">Tipo de violencia</label>
          <select id="violencia" name="fk_tipo_violencia" required>
            <option value="">Selecciona un tipo</option>
            <?php $__currentLoopData = $tiposViolencia ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($tipo->id_tipo_violencia ?? $tipo->id); ?>"><?php echo e($tipo->nombre ?? $tipo->tipo); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
...
</html><?php /**PATH C:\xampp\htdocs\univida\resources\views/reporte.blade.php ENDPATH**/ ?>