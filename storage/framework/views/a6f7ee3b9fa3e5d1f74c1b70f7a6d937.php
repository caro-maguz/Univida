...
<body>
  ...
  <div class="registro-container">
    ...
    <!-- Formulario -->
    <form id="registroForm" action="<?php echo e(route('register.user.process')); ?>" method="POST">
      <?php echo csrf_field(); ?>
    ...
    <div class="extra-links">
      <p><a href="<?php echo e(route('login.user')); ?>">¿Ya tienes cuenta? Inicia sesión</a></p>
    </div>
  </div>
...
</html><?php /**PATH C:\xampp\htdocs\univida\resources\views/register-user.blade.php ENDPATH**/ ?>