...
<header>
    ...
    <div class="card">
      ...
      <section class="contenido">
        ...
        <div class="buttons">
          ...
          <a href="<?php echo e(route('test.mostrar')); ?>" class="btn">🧠 Realizar Test</a>
          ...
          <a href="<?php echo e(route('test.historial')); ?>" class="btn">📊 Mi Historial</a>
        </div>
  ...
  <script>
    ...
    async function obtenerMotivacion() {
      try {
        const resp = await fetch('<?php echo e(route('notificacion.siguiente')); ?>', { credentials: 'same-origin' });
        if (!resp.ok) return;
    ...
    document.getElementById('saveFreq').addEventListener('click', async ()=>{
      ...
      try{
        const resp = await fetch('<?php echo e(route('notificacion.config')); ?>', {
          method: 'POST',
