...
<body>
  ...
  <form action="<?php echo e(route('administrador.recursos.update', $recurso->id_recurso)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <?php echo method_field('PUT'); ?>
    <div class="group">
      <label for="titulo">Título *</label>
      <input type="text" id="titulo" name="titulo" value="<?php echo e(old('titulo', $recurso->titulo)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="group">
      ...
      <textarea id="descripcion" name="descripcion"><?php echo e(old('descripcion', $recurso->descripcion)); ?></textarea>
    ...
    <div class="group">
      ...
      <select name="fk_tipo_recurso" id="fk_tipo_recurso" required>
        <?php $__currentLoopData = $tipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($t->id_tipo_recurso); ?>" <?php if(old('fk_tipo_recurso', $recurso->fk_tipo_recurso) == $t->id_tipo_recurso): echo 'selected'; endif; ?>><?php echo e($t->nombre); ?></option>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="group">
      ...
      <input type="url" id="enlace" name="enlace" placeholder="https://..." value="<?php echo e(old('enlace', $recurso->enlace)); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="group">
      <label for="archivo">Archivo (opcional, sube para reemplazar enlace)</label>
...
unset($__errorArgs, $__bag); ?>
      <?php if($recurso->enlace): ?>
        <p style="margin-top:6px; font-size:13px;">Actual: <a href="<?php echo e($recurso->enlace); ?>" target="_blank" rel="noopener">Abrir enlace</a></p>
      <?php endif; ?>
    </div>
    <div class="actions">
...
<?php /**PATH C:\xampp\htdocs\univida\resources\views/administrador/recursos/edit.blade.php ENDPATH**/ ?>