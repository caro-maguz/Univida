...
<body>
  ...
  <header>
    <div class="Logo">
      <a href="<?php echo e(route('about')); ?>">
        <img src="<?php echo e(asset('img/Logo.png')); ?>" alt="Logo Univida">
        <span class="Logo-text">Univida</span>
      </a>
    </div>
    <div class="nav-links">
      <a href="<?php echo e(route('login.user')); ?>"><button class="login-button">Iniciar Sesión</button></a>
    </div>
  </header>
  ...
  <section class="hero-section">
    <div class="carousel">
      <img src="<?php echo e(asset('img/imagen1.png')); ?>" class="active" alt="Fondo 1">
      <img src="<?php echo e(asset('img/imagen2.png')); ?>" alt="Fondo 2">
      <img src="<?php echo e(asset('img/imagen3.png')); ?>" alt="Fondo 3">
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\univida\resources\views/welcome.blade.php ENDPATH**/ ?>