...
<body>
    <div class="top-bar">
        ...
        <a href="<?php echo e(route('dashboard.psychologist')); ?>" class="back">← Volver al panel</a>
    </div>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $historias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $historia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a class="btn-small btn-view" href="<?php echo e(route('psychologist.historias.show', $historia->id)); ?>"><i class="fas fa-eye"></i> Ver</a>
                            ...
                            <?php if($historia->estado === 'pendiente'): ?>
                                ...
                                <form id="rechazar-<?php echo e($historia->id); ?>" action="<?php echo e(route('psychologist.historias.rechazar', $historia->id)); ?>" method="POST" style="display:inline">
                                    <?php echo csrf_field(); ?>
                            ...
                            <a class="btn-small btn-edit" href="<?php echo e(route('psychologist.historias.edit', $historia->id)); ?>"><i class="fas fa-edit"></i> Editar</a>
                            <form action="<?php echo e(route('psychologist.historias.destroy', $historia->id)); ?>" method="POST" style="display:inline" onsubmit="return confirm('¿Eliminar esta historia?')">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\univida\resources\views/psychologist/historias/index.blade.php ENDPATH**/ ?>