...
<body>
  <div class="container">
    <a href="<?php echo e(route('dashboard.user')); ?>" class="volver">← Volver al inicio</a>
    ...
    <?php if($tests->isEmpty()): ?>
      <div class="empty">
        ...
        <a href="<?php echo e(route('test.mostrar')); ?>" class="btn">Realizar Test Ahora</a>
      </div>
    <?php else: ?>
      <?php $__currentLoopData = $tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="test-card">
          <div class="test-info">
            ...
            <p class="test-fecha">
              📅 Realizado el: <?php echo e(\Carbon\Carbon::parse($test->fecha)->format('d/m/Y H:i')); ?>
          ...
          <div>
            ...
            ?>
            <span class="badge <?php echo e($clase); ?>"><?php echo e($test->resultado); ?></span>
          </div>
        </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

      <div style="text-align: center; margin-top: 2rem;">
        <a href="<?php echo e(route('test.mostrar')); ?>" class="btn">🔄 Realizar Nuevo Test</a>
      </div>
    <?php endif; ?>
  </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\univida\resources\views/test/historial.blade.php ENDPATH**/ ?>