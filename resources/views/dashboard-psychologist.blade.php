...
<body>
  ...
  <main class="main">
    <section class="hero">
      ...
      <img src="{{ asset('img/mascotainicio.png') }}" alt="mascotainicio" class="mascotainicio">
    </section>
    ...
    <div class="cards">
      ...
      <div class="card">
        ...
        <a href="{{ route('psychologist.historias.index') }}" class="card-link">Moderar historias</a>
      </div>
    </div>
  </main>
