  ...
  <div class="container">
    ...
    <form action="{{ route('password.update') }}" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="email" id="correo" name="correo" placeholder="usuario@uniautonoma.edu.co" required value="{{ old('correo') }}">
      </div>

      <div class="form-group">
        <label for="codigo">Código de Verificación (4 dígitos)</label>
        <input type="text" id="codigo" name="codigo" placeholder="0000" required maxlength="4" pattern="[0-9]{4}" style="text-align: center; font-size: 1.5rem; letter-spacing: 0.5rem;" value="{{ old('codigo') }}">
      </div>
    ...
    <a href="{{ route('login.user') }}" class="back-link">← Volver al inicio de sesión</a>
  </div>
