        ...
        <div class="card-body">
            ...
            <div class="actions">
                @if($historia->estado === 'pendiente')
                    ...
                    <form id="rechazar-actual" action="{{ route('psychologist.historias.rechazar', $historia->id) }}" method="POST" style="display:inline">
                        @csrf
                ...
                <a href="{{ route('psychologist.historias.edit', $historia->id) }}" class="edit"><i class="fas fa-edit"></i> Editar</a>
                <form action="{{ route('psychologist.historias.destroy', $historia->id) }}" method="POST" style="display:inline" onsubmit="return confirm('¿Estás seguro de eliminar esta historia?')">
                    @csrf
                    @method('DELETE')
