...
<div class="main">
    <div class="section-header">
        <h2 style="font-size: 24px; color: #0d47a1;">Registrar Nuevo Psicólogo</h2>
    ...
    <div class="form-container" style="background: white; padding: 30px; border-radius: 16px; box-shadow: 0 4px 16px rgba(0,0,0,0.07);">
        <form method="POST" action="{{ route('psicologos.store') }}">
            ...
            <div style="margin-bottom: 20px;">
                <label style="display: block; margin-bottom: 8px; font-weight: 600; color: #333;">Contraseña</label>
                <input type="password" name="contrasena" required 
                       style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 16px;">
            </div>

            <div style="margin-bottom: 20px;">
                <label style="display: block; margin-bottom: 8px; font-weight: 600; color: #333;">Teléfono (opcional)</label>
